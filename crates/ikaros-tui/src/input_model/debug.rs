...
pub(crate) fn screen_debug_model_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn debug_surface_json(
    id: &str,
    label: &str,
...
pub(crate) fn screen_navigation_json() -> Vec<serde_json::Value> {
    [

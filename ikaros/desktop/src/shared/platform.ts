...
export const DESKTOP_IPC_CHANNELS = Object.freeze({
  runtime: {
    ...
    processRead: "ikaros:runtime:process-read",
    processStop: "ikaros:runtime:process-stop",
    runSteer: "ikaros:runtime:run-steer",
    ...
    modelSetLimits: "ikaros:runtime:model-set-limits",
    ...
    memoryCorrect: "ikaros:runtime:memory-correct",

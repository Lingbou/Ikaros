...
pub(super) fn command_action_label(command: &str) -> &str {
    match command {
        ...
        _ if command.starts_with("/sessions") => "Inspect sessions",
        _ if command.starts_with("/session") => "Inspect session",
        _ if command.starts_with("/context") => "Inspect context",
        _ if command.starts_with("/memory") => "Inspect memory",

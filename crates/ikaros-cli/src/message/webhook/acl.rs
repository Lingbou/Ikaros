...
use ikaros_gateway::GatewayRoute;
use std::collections::BTreeSet;

#[derive(Debug, Clone, Default)]
pub(super) struct MessageWebhookAcl {
...
impl MessageWebhookAcl {
    ...
    pub(super) fn validate_route(&self, route: &GatewayRoute) -> Result<(), &'static str> {

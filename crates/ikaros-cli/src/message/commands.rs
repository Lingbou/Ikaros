...
pub(crate) struct MessageSend {
    pub(in crate::message) content: String,
    #[arg(long, value_enum, default_value = "chat")]
    pub(in crate::message) kind: MessageKindArg,
    #[arg(long, default_value = "cli")]
    pub(in crate::message) source: String,
    #[arg(long)]
    pub(in crate::message) account: Option<String>,
    #[arg(long)]
    pub(in crate::message) peer: Option<String>,
    #[arg(long)]
    pub(in crate::message) thread: Option<String>,
    #[arg(long = "message-id")]
    pub(in crate::message) message_id: Option<String>,
    #[arg(long = "idempotency-key")]
    pub(in crate::message) idempotency_key: Option<String>,
    #[arg(long, value_name = "PROFILE")]
    pub(in crate::message) profile: Option<String>,
}

#[derive(Debug, Args)]
pub(crate) struct MessageWorker {
    #[arg(long = "interval-seconds", default_value_t = 60)]
    pub(in crate::message) interval_seconds: u64,
    #[arg(long, default_value_t = 10)]
    pub(in crate::message) limit: usize,
    #[arg(long)]
    pub(in crate::message) once: bool,
}

#[derive(Debug, Args)]
pub(crate) struct MessageWorkerStop {
    #[arg(long, default_value = "operator requested stop")]
    pub(in crate::message) reason: String,
}
...
pub(crate) struct MessageCancel {
    pub(in crate::message) id: String,
...
pub(crate) struct MessageDeliveryClaim {
    ...
    pub(in crate::message) owner: String,
}
...
pub(crate) struct MessageDeliveryAck {
    ...
    pub(in crate::message) lease_owner: String,
    #[arg(long, default_value = "delivered")]
    pub(in crate::message) summary: String,
}
...
pub(crate) struct MessageDeliveryFail {
    ...
    pub(in crate::message) max_attempts: u32,
    #[arg(long = "backoff-seconds", default_value_t = 60)]
    pub(in crate::message) backoff_seconds: u64,
}
...
pub(crate) struct MessagePairingCreate {
    ...
    pub(in crate::message) account: Option<String>,
    #[arg(long)]
    pub(in crate::message) peer: String,
}
...
pub(crate) struct MessageAdapterEnqueue {
    ...
    pub(in crate::message) platform: String,
    #[arg(long, value_enum, default_value = "chat")]
    pub(in crate::message) kind: MessageKindArg,
    #[arg(long)]
    pub(in crate::message) account: Option<String>,
    ...
    pub(in crate::message) idempotency_key: Option<String>,
    #[arg(long = "profile")]
    pub(in crate::message) agent: Option<String>,
    #[arg(long)]
    pub(in crate::message) safe_tools: bool,
}

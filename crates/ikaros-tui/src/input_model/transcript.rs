...
pub(crate) fn screen_surface_cell_json(cell: &WorkbenchCell) -> serde_json::Value {
...
pub(crate) fn screen_transcript_model_json(
...
pub(crate) fn transcript_cell_json(
...
pub(crate) fn transcript_cell_cache_key(
    source_panel: &str,
    cell: &WorkbenchCell,
    live: bool,
) -> String {
...
pub(crate) fn transcript_cell_transcript_key(source_panel: &str, cell: &WorkbenchCell) -> String {
...
pub(crate) fn stable_text_fingerprint(input: &str) -> String {
...
pub(crate) fn transcript_cell_height_hint(cell: &WorkbenchCell) -> usize {
...
pub(crate) fn transcript_cell_hyperlinks(cell: &WorkbenchCell) -> Vec<serde_json::Value> {

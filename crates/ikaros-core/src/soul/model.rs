...
mod tests {
    ...
    fn persona_document_context_truncates_on_utf8_boundary() {
        let profile = PersonaProfile {
            identity: Identity {
                name: "unicode persona".into(),
                role: "persona".into(),
                description: "multi-byte persona".into(),
            },
            traits: Vec::new(),
            tone: ToneConfig {
                style: "test tone".into(),
                language: Some("unicode".into()),
            },
            relationship: RelationshipModel {
                stance: "test relationship".into(),
                boundaries: Vec::new(),
            },
            behavior_rules: Vec::new(),
            documents: vec![PersonaDocument {
                source: Some("voice.md".into()),
                content: "\u{6d4b}".repeat(100),
            }],

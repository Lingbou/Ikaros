...
pub(in crate::chat::workbench::screen) fn screen_readiness_model_json(
...
pub(in crate::chat::workbench::screen) fn readiness_status(
    available: bool,
    attention: bool,
) -> &'static str {
    if !available {
...
pub(in crate::chat::workbench::screen) fn readiness_gate_json(
    id: &str,
    label: &str,
    status: &str,
    evidence: &str,

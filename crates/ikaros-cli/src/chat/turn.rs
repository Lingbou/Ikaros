...
use ikaros_terminal::{RunningTurnInputCapture, print_inline_turn_worked_separator};
use serde_json::json;
...
pub(in crate::chat) struct InteractiveChatTurnContext<'a> {
    ...
    pub(in crate::chat) persona: &'a ikaros_agent::soul::PersonaProfile,
...
struct InteractiveMemoryLifecycle {
    ...
    policy: ikaros_state::memory::MemoryPolicy,
    agent_id: String,

...
pub(in crate::chat::workbench::screen) fn extract_assignment_commands(
    input: &str,
    key: &str,
) -> Vec<String> {
...
pub(in crate::chat::workbench::screen) fn extract_assignment_display(
    input: &str,
    key: &str,
    default: &str,
) -> String {
...
pub(in crate::chat::workbench::screen) fn extract_assignment_span(
    input: &str,
    key: &str,
    terminators: &[&str],
) -> Option<String> {
...
pub(in crate::chat::workbench::screen) fn extract_token_after(
    input: &str,
    key: &str,
) -> Option<String> {
    input
...
pub(in crate::chat::workbench::screen) fn default_cell_command(

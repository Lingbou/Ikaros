...
use super::{
    ...
    parse_debug_dump_recent_logs, parse_debug_logs_args, print_debug_status_for_human,
    terminal_inline,
};
...
use crate::chat::workbench::{
    ...
    print_rag_status_for_human, print_replay_status, print_replay_status_for_human,
    print_screen_status_with_state, print_slash_commands, print_slash_commands_for_human,

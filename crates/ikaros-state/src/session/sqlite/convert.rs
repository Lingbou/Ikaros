...
pub(super) fn event_source_to_str(source: crate::session::AgentEventSource) -> &'static str {
    match source {
        crate::session::AgentEventSource::Runtime => "runtime",
        crate::session::AgentEventSource::User => "user",
        crate::session::AgentEventSource::Model => "model",
        crate::session::AgentEventSource::Tool => "tool",
        crate::session::AgentEventSource::Harness => "harness",
        crate::session::AgentEventSource::Context => "context",
        crate::session::AgentEventSource::Memory => "memory",
        crate::session::AgentEventSource::Audit => "audit",
    }
}

pub(super) fn event_source_from_str(value: &str) -> Result<crate::session::AgentEventSource> {
    match value {
        "runtime" => Ok(crate::session::AgentEventSource::Runtime),
        "user" => Ok(crate::session::AgentEventSource::User),
        "model" => Ok(crate::session::AgentEventSource::Model),
        "tool" => Ok(crate::session::AgentEventSource::Tool),
        "harness" => Ok(crate::session::AgentEventSource::Harness),
        "context" => Ok(crate::session::AgentEventSource::Context),
        "memory" => Ok(crate::session::AgentEventSource::Memory),
        "audit" => Ok(crate::session::AgentEventSource::Audit),
        other => Err(IkarosError::Message(format!(

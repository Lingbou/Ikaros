...
pub(crate) fn selected_cell_index(
    screen: &WorkbenchScreen,
...
pub(crate) fn selected_action_command(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
) -> Option<String> {
...
pub(crate) fn screen_action_menu_command_by_selector(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
    selector: &str,
) -> Option<String> {
...
pub(crate) fn action_menu_item_command_if_matches(
    group_id: Option<&str>,
...
pub(crate) fn action_menu_item_matches_selector(
    group_id: Option<&str>,
    item: &serde_json::Value,
    selector: &str,
) -> bool {
...
pub(crate) fn action_menu_text_matches_selector(value: &str, selector: &str) -> bool {
...
pub(crate) fn compact_action_selector(value: &str) -> String {
    value
        .chars()
...
pub(crate) fn screen_action_matches_selector(command: &str, selector: &str) -> bool {
...
pub(crate) fn parse_screen_selector(
    args: &[&str],
    start: usize,
    argument_name: &str,
) -> Result<(String, usize)> {
...
pub(crate) fn is_screen_selector_boundary(value: &str) -> bool {
    value.starts_with("--")
        || matches!(
            value,
            "focus"

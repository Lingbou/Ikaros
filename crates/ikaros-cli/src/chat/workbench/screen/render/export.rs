...
pub(in crate::chat) fn screen_selected_cell_line(
...
pub(in crate::chat::workbench::screen) fn selected_cell_detail_line(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
) -> String {
    let panel = state.focused_panel();
...
pub(in crate::chat) fn screen_selected_actions_line(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
) -> String {
    let panel = state.focused_panel();
...
pub(in crate::chat) fn screen_selected_actions_json_line(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
) -> String {
    let panel = state.focused_panel();
...
pub(in crate::chat) fn screen_json_line(
    screen: &WorkbenchScreen,
    state: &WorkbenchScreenState,
) -> String {

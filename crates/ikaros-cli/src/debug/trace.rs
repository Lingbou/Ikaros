...
pub(in crate::debug) fn model_stream_event_kind(kind: &AgentEventKind) -> Option<&'static str> {
    ...
    Some(match event {
        ikaros_providers::model::ModelStreamEvent::Start { .. } => "start",
        ikaros_providers::model::ModelStreamEvent::TextDelta(_) => "text_delta",
        ikaros_providers::model::ModelStreamEvent::ReasoningDelta(_) => "reasoning_delta",
        ikaros_providers::model::ModelStreamEvent::ToolCallStart { .. } => "tool_call_start",
        ikaros_providers::model::ModelStreamEvent::ToolCallDelta { .. } => "tool_call_delta",
        ikaros_providers::model::ModelStreamEvent::ToolCallEnd { .. } => "tool_call_end",
        ikaros_providers::model::ModelStreamEvent::RefusalDelta(_) => "refusal_delta",
        ikaros_providers::model::ModelStreamEvent::Usage(_) => "usage",
        ikaros_providers::model::ModelStreamEvent::Error { .. } => "error",
        ikaros_providers::model::ModelStreamEvent::Done => "done",
    })
}

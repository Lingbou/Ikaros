...
pub fn screen_selected_primary_action(
...
pub(crate) fn screen_recovery_primary_command(screen: &WorkbenchScreen) -> Option<String> {
...
pub(crate) fn screen_approval_primary_command(screen: &WorkbenchScreen) -> Option<String> {
...
pub(crate) fn selected_cell_actions(cell: &WorkbenchCell) -> Vec<String> {
...
pub(crate) fn dedupe_commands(commands: Vec<String>) -> Vec<String> {
    commands
        .into_iter()

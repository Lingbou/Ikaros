...
pub(crate) fn screen_timeline_groups_json(screen: &WorkbenchScreen) -> Vec<serde_json::Value> {
    screen
        .timeline
        .iter()
        .filter_map(|cell| {
...
pub(crate) fn screen_timeline_group_model_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
#[derive(Debug, Clone)]
pub(crate) struct TimelineTabModel {
    pub(crate) id: &'static str,
    pub(crate) label: &'static str,
    pub(crate) count: usize,
    pub(crate) attention: bool,
    pub(crate) kind_filter: Option<&'static str>,
    pub(crate) timeline_command: String,
    pub(crate) trace_command: String,
    pub(crate) replay_command: String,
    pub(crate) focus_action: String,
    pub(crate) shortcut: Option<&'static str>,
}

pub(crate) fn screen_timeline_tabs_model_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn screen_timeline_tab_json(tab: TimelineTabModel) -> serde_json::Value {
    serde_json::json!({
        "id": tab.id,
        "label": tab.label,
        "count": tab.count,
...
pub(crate) fn screen_timeline_tabs(screen: &WorkbenchScreen) -> Vec<TimelineTabModel> {
    [
...
pub(crate) fn timeline_tab_commands(
    id: &'static str,
...
pub(crate) fn timeline_tab_count(screen: &WorkbenchScreen, id: &str) -> usize {
    match id {
...
pub(crate) fn timeline_visible_item_count(screen: &WorkbenchScreen) -> usize {
...
pub(crate) fn timeline_group_event_count(screen: &WorkbenchScreen, category: &str) -> usize {
...
pub(crate) fn timeline_provider_count(screen: &WorkbenchScreen) -> usize {
...
pub(crate) fn timeline_cells_of_kind(screen: &WorkbenchScreen, kind: WorkbenchCellKind) -> usize {
    timeline_cells_matching(screen, |cell| cell.kind == kind)
}

pub(crate) fn timeline_cells_matching(
...
pub(crate) fn timeline_cell_contains(cell: &WorkbenchCell, needles: &[&str]) -> bool {
...
pub(crate) fn timeline_tab_needs_attention(
    screen: &WorkbenchScreen,
    id: &str,
    count: usize,
) -> bool {
...
pub(crate) fn screen_timeline_panel_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn screen_timeline_filters_json(screen: &WorkbenchScreen) -> Vec<serde_json::Value> {
...
pub(crate) fn screen_timeline_quick_jumps_json(
...
pub(crate) fn screen_replay_point_json(cell: &WorkbenchCell) -> serde_json::Value {
    serde_json::json!({
        "kind": cell.kind.as_str(),

...
pub(in crate::chat::workbench::screen) fn panel_cell_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
...
pub(in crate::chat::workbench::screen) fn find_cell<'a>(
...
pub(in crate::chat::workbench::screen) fn all_cells<'a>(
    screen: &'a WorkbenchScreen,
...
pub(in crate::chat::workbench::screen) fn screen_bottom_pane_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
    let active_view =
...
pub(in crate::chat::workbench::screen) fn bottom_pane_modal_stack(
    active_view: &str,
) -> Vec<&'static str> {
    match active_view {
...
pub(in crate::chat::workbench::screen) fn bottom_pane_view_stack_json(
    active_view: &str,
    cell: &WorkbenchCell,
...
pub(in crate::chat::workbench::screen) fn bottom_pane_view_requires_action(
    active_view: &str,
) -> bool {
    matches!(active_view, "approval" | "input_queue" | "attachments")
}

pub(in crate::chat::workbench::screen) fn bottom_pane_cancel_behavior(
    active_view: &str,
) -> &'static str {
    match active_view {
...
pub(in crate::chat::workbench::screen) fn bottom_pane_escape_behavior(
    active_view: &str,
) -> &'static str {
    match active_view {
...
pub(in crate::chat::workbench::screen) fn bottom_pane_completion_actions_json(
    active_view: &str,
    cell: &WorkbenchCell,
) -> serde_json::Value {
    match active_view {
...
pub(in crate::chat::workbench::screen) fn screen_surface_progress_json(
...
pub(in crate::chat::workbench::screen) fn screen_idle_progress_json() -> serde_json::Value {
    serde_json::json!({
        "kind": "idle",
        "status": "idle",
        "phase": "idle",
...
pub(in crate::chat::workbench::screen) fn screen_modal_cell(
    screen: &WorkbenchScreen,

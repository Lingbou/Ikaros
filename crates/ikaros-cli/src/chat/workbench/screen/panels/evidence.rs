...
pub(in crate::chat::workbench::screen) fn screen_coding_groups_json(
...
pub(in crate::chat::workbench::screen) fn latest_coding_group_cell<'a>(
...
pub(in crate::chat::workbench::screen) fn screen_evidence_json(
    screen: &WorkbenchScreen,
) -> Vec<serde_json::Value> {
    [
...
pub(in crate::chat::workbench::screen) fn screen_evidence_area_json(
    screen: &WorkbenchScreen,
    area: &str,
...
pub(in crate::chat::workbench::screen) fn cell_matches_evidence_area(
    cell: &WorkbenchCell,
    area: &str,
    fallback_kind: WorkbenchCellKind,
) -> bool {
...
pub(in crate::chat::workbench::screen) fn evidence_cell_needs_attention(
    cell: &WorkbenchCell,
) -> bool {
    matches!(
        cell.kind,

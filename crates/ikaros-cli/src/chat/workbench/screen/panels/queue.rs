...
pub(in crate::chat::workbench::screen) fn screen_queue_panel_json(
...
pub(in crate::chat::workbench::screen) fn screen_queue_continuation_cells(
    screen: &WorkbenchScreen,
) -> Vec<&WorkbenchCell> {
    all_cells(screen)
        .filter(|cell| {
...
pub(in crate::chat::workbench::screen) fn queue_continuation_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
...
pub(in crate::chat::workbench::screen) fn queue_pending_input_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
    let commands = selected_cell_actions(cell);
    serde_json::json!({
...
pub(in crate::chat::workbench::screen) fn queue_attachment_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
    let commands = selected_cell_actions(cell);
    serde_json::json!({
...
pub(in crate::chat::workbench::screen) fn screen_queue_recovery_json(
    screen: &WorkbenchScreen,
) -> serde_json::Value {

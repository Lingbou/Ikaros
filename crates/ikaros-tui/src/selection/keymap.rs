...
pub(crate) fn screen_key_bindings_json() -> Vec<serde_json::Value> {
    [
...
pub(crate) fn screen_keymap_model_json(
...
pub(crate) fn keymap_group_json(
    id: &str,
    label: &str,
...
pub(crate) fn keymap_binding_json(
    key: &str,
    action: &str,
    command: &str,
    scope: &str,

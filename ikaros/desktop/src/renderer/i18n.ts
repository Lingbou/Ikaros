...
const english = {
  ...
  "settings.providers.credentialNotice":
    "This key is used only for this mock connection and is never saved.",
...
const simplifiedChinese: Record<TranslationKey, string> = {
  ...
  "settings.providers.credentialNotice": "此密钥仅用于本次模拟连接，不会保存。",
  "settings.providers.providerId": "供应商 ID",
  "settings.providers.providerIdHint": "仅可使用小写字母、数字、连字符或下划线",
  "settings.providers.providerIdPlaceholder": "myprovider",

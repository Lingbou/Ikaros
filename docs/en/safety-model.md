...
Ikaros treats tool use as a controlled operation. The harness is the boundary between a model,
persona, command, or scheduler asking for work and the runtime actually doing it.

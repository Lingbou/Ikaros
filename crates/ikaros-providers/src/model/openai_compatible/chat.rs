...
use crate::model::http::{ModelHttpRequest, ModelHttpStreamResponse};
use crate::model::params::merge_request_options;
...
impl ModelProvider for OpenAiCompatibleProvider {
    ...
    async fn stream(&self, request: ModelRequest) -> Result<ModelStream> {
        let mut sink = crate::model::types::NoopModelStreamEventSink;

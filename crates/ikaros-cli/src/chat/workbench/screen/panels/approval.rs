...
pub(in crate::chat::workbench::screen) fn screen_approval_panel_json(
...
pub(in crate::chat::workbench::screen) fn screen_approval_decision_model_json(
    screen: &WorkbenchScreen,
) -> serde_json::Value {
...
pub(in crate::chat::workbench::screen) fn approval_decision_model_json(
    pending: &str,
...
pub(in crate::chat::workbench::screen) fn approval_pending_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {

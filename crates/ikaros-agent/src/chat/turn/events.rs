...
use ikaros_state::memory::MemoryLifecycleReport;
use ikaros_state::session::{AgentEvent, AgentEventKind, AgentEventSource, SessionId, TurnId};
use serde_json::json;
...
pub fn emit_memory_lifecycle_report(
    sink: &dyn AgentEventSink,
    session_id: &SessionId,
    turn_id: &TurnId,
    agent_id: &str,

...
pub(super) fn emit_session_approval_record(
    ...
    let status = match record.status {
        ikaros_execution::harness::ApprovalStatus::Pending => SessionApprovalStatus::Requested,
        ikaros_execution::harness::ApprovalStatus::Approved => SessionApprovalStatus::Approved,
        ikaros_execution::harness::ApprovalStatus::Denied => SessionApprovalStatus::Denied,
        ikaros_execution::harness::ApprovalStatus::Executed => SessionApprovalStatus::Executed,
    };
    let decision = match record.status {
        ikaros_execution::harness::ApprovalStatus::Pending => None,

...
pub(in crate::chat::workbench::screen) fn screen_context_panel_json(
...
pub(in crate::chat::workbench::screen) fn context_section_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
...
pub(in crate::chat::workbench::screen) fn context_section_is_protected(
    cell: &WorkbenchCell,
) -> bool {
...
pub(in crate::chat::workbench::screen) fn context_reference_item_json(
    cell: &WorkbenchCell,
) -> serde_json::Value {
    let commands = selected_cell_actions(cell);
    serde_json::json!({
...
pub(in crate::chat::workbench::screen) fn context_coverage_json(
    source_coverage: Option<&WorkbenchCell>,
) -> serde_json::Value {
    serde_json::json!({
...
pub(in crate::chat::workbench::screen) fn context_budget_status_json(
...
pub(in crate::chat::workbench::screen) fn context_compaction_state_json(

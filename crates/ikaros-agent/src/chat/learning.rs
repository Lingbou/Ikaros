...
fn relationship_candidate_from_statement(statement: &str) -> Option<String> {
    ...
    if let Some(value) = candidate_after_any(
        ...
        &[
            ...
            "please call me ",
            "my name is ",
            "\u{4ee5}\u{540e}\u{53eb}\u{6211}",
            "\u{8bf7}\u{53eb}\u{6211}",
            "\u{53eb}\u{6211}",
            "\u{6211}\u{7684}\u{540d}\u{5b57}\u{662f}",
        ],
    ) {
    ...
    if let Some(value) = candidate_after_any(
        ...
        &[
            ...
            "\u{6211}\u{66f4}\u{559c}\u{6b22}",
            "\u{6211}\u{559c}\u{6b22}",
            "\u{6211}\u{4e0d}\u{559c}\u{6b22}",
            "\u{6211}\u{8ba8}\u{538c}",
        ],
    ) {

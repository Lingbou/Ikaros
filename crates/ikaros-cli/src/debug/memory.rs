...
pub(in crate::debug) fn memory_journal_action_name(
    action: &ikaros_state::memory::MemoryJournalAction,
) -> &'static str {
    match action {
        ikaros_state::memory::MemoryJournalAction::Append => "append",
        ikaros_state::memory::MemoryJournalAction::Update => "update",
        ikaros_state::memory::MemoryJournalAction::Promote => "promote",
        ikaros_state::memory::MemoryJournalAction::Demote => "demote",
        ikaros_state::memory::MemoryJournalAction::Forget => "forget",
        ikaros_state::memory::MemoryJournalAction::Skip => "skip",
        ikaros_state::memory::MemoryJournalAction::CandidateCreated => "candidate_created",
        ikaros_state::memory::MemoryJournalAction::CandidateAccepted => "candidate_accepted",
        ikaros_state::memory::MemoryJournalAction::CandidateRejected => "candidate_rejected",
        ikaros_state::memory::MemoryJournalAction::ProjectionRendered => "projection_rendered",
        ikaros_state::memory::MemoryJournalAction::Superseded => "superseded",
        ikaros_state::memory::MemoryJournalAction::WorkingMemoryExpired => "working_memory_expired",
    }
}

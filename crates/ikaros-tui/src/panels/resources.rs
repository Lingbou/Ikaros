...
pub(crate) fn screen_memory_panel_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn screen_rag_panel_json(screen: &WorkbenchScreen) -> serde_json::Value {

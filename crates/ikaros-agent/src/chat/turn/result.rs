...
use ikaros_providers::model::{ModelRequestDiagnostic, ModelResponse};
use ikaros_state::session::{AgentEvent, AgentEventKind, AgentEventSource};
use serde_json::json;
...
fn record_final_emotion_signal(
    ...
    setup: &ChatTurnSetup,
    result: &ChatModelResult,
) -> Result<ikaros_core::EmotionState> {

...
pub(crate) fn screen_provider_panel_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn provider_panel_needs_attention(
    health_status: &str,
    budget_status: &str,
    last_error_kind: &str,
    cooldown_until: &str,
...
pub(crate) fn provider_recovery_actions_json(

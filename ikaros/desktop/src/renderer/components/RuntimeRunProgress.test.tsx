...
const turn: Turn = {
  ...
  runProgress: {
    ...
    modelCalls: 0, maxModelCalls: 100, maxDurationSeconds: 3600,
  },
};
...
describe("RuntimeRunProgress", () => {
  it("counts queue time separately and freezes elapsed time at settlement", () => {
    ...
    expect(screen.getByLabelText("Task execution")).toHaveTextContent("Model calls 0 / 100");
    ...
    expect(screen.getByLabelText("Task execution")).toHaveTextContent("Elapsed 0:12 / 60:00");
    expect(screen.getByLabelText("Task execution")).toHaveTextContent("Model calls 3 / 100");

...
const SLASH_COMMAND_REGISTRY_VERSION: u32 = 2;
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(in crate::chat) struct SlashCommandCompletion {
    pub(in crate::chat) name: &'static str,
    pub(in crate::chat) usage: &'static str,
    pub(in crate::chat) summary: &'static str,
    pub(in crate::chat) argument_model: &'static str,
    pub(in crate::chat) effect: &'static str,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::chat) struct SlashCommandPaletteItem {
    pub(in crate::chat) name: &'static str,
    pub(in crate::chat) usage: &'static str,
    pub(in crate::chat) summary: &'static str,
    pub(in crate::chat) argument_model: &'static str,
    pub(in crate::chat) effect: &'static str,
    pub(in crate::chat) permissions: String,
    pub(in crate::chat) surfaces: String,
    pub(in crate::chat) tags: String,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::chat) struct SlashCommandPaletteSummary {
    pub(in crate::chat) query: String,
    pub(in crate::chat) command_count: usize,
    pub(in crate::chat) total_commands: usize,
    pub(in crate::chat) effects: String,
    pub(in crate::chat) permissions: String,
    pub(in crate::chat) surfaces: String,
}
...
impl SlashCommandDescriptor {
    fn argument_model(self) -> SlashCommandArgumentModel {
        match self.name {
            ...
            "/commands" | "/history" | "/resume" | "/timeline" | "/replay" | "/debug"
            | "/trace" | "/mentions" | "/review" | "/sandbox" => {
                SlashCommandArgumentModel::Optional
            }
            "/agent" | "/rollback" => SlashCommandArgumentModel::Required,
            "/queue" | "/attach" | "/budget" | "/screen" | "/session" | "/provider"
            | "/approval" | "/approvals" | "/cancel" | "/code" | "/mcp" | "/api" | "/browser"
            | "/web" | "/vision" | "/image" | "/gateway" => SlashCommandArgumentModel::Subcommand,
    ...
    fn effect(self) -> SlashCommandEffect {
        match self.name {
            ...
            "/session" | "/resume" | "/new" | "/fork" | "/screen" => {
...
pub(in crate::chat) fn slash_command_completion_candidates(
    input: &str,
    limit: usize,
...
pub(in crate::chat) fn slash_completion_query(input: &str) -> &str {
...
pub(in crate::chat) fn slash_command_registry_summary() -> String {
    format!(
...
pub(in crate::chat) fn slash_command_palette_summary(
    query: Option<&str>,
...
pub(in crate::chat) fn slash_command_palette_items(
    query: Option<&str>,
    limit: usize,
...
pub(in crate::chat) fn format_slash_command_help() -> String {
...
pub(in crate::chat) fn print_slash_commands(args: &[&str]) {

...
pub(crate) fn screen_coding_panel_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn screen_coding_loop_model_json(screen: &WorkbenchScreen) -> serde_json::Value {
...
pub(crate) fn coding_loop_step_json(
    id: &str,
    label: &str,
    command: &str,
    available: bool,
...
pub(crate) fn latest_coding_failure_cell(screen: &WorkbenchScreen) -> Option<&WorkbenchCell> {
    screen
        .main
        .iter()
        .rev()
...
pub(crate) fn coding_phase_count(workflow: Option<&WorkbenchCell>, key: &str) -> String {
    workflow

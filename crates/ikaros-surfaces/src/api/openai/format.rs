...
pub(in crate::api) fn emit_api_model_tool_call_events(
    ...
    for (index, call) in calls.iter().enumerate() {
        ...
        evidence.emit(
            ...
            AgentEventKind::ModelStream(ikaros_providers::model::ModelStreamEvent::ToolCallStart {
                id: call_id.clone(),
        ...
        evidence.emit(
            AgentEventSource::Model,
            AgentEventKind::ModelStream(ikaros_providers::model::ModelStreamEvent::ToolCallEnd {
                id: call_id.clone(),
            }),
            json!({
                "surface": "openai-compatible-api",
...
pub(in crate::api) struct ApiResponsesBody {
    ...
    pub(in crate::api) diagnostics: Vec<ikaros_providers::model::ModelRequestDiagnostic>,
